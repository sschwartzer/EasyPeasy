# EasyPeasy
A tool for securing passwords in a domain by reciving a text file with all the details - usernames with duplicted passwords, amd usernames with a weak password.
...
The tool run on PowerShell version 4 or 5.
